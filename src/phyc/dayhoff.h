...
#ifndef PhyC_dayhoff_h
#define PhyC_dayhoff_h

#include "substmodel.h"

static const double AMINO_ACID_MODEL_DAYHOFF[20][20] = {
...
struct SubstitutionModel *new_DAYHOFF_with_parameters(Parameter *freqs);
