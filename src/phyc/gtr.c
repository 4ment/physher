...
SubstitutionModel * new_GTR_with_values( const double *freqs, const double *rates ){
    ...
    Parameters_add(m->freqs, new_Parameter_with_postfix("gtr.piA", "model", freqs[0]/freqs[3], new_Constraint(0.001, 100) ) );
    Parameters_add(m->freqs, new_Parameter_with_postfix("gtr.piC", "model", freqs[1]/freqs[3], new_Constraint(0.001, 100) ) );
    Parameters_add(m->freqs, new_Parameter_with_postfix("gtr.piG", "model", freqs[2]/freqs[3], new_Constraint(0.001, 100) ) );
